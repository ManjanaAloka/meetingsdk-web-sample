...
function websdkready() {
    ...
    var CLIENT_ID = "wcSFC2i9Q0ue_MF2pjL6Ug";
    /**
     ...
     */
    var CLIENT_SECRET = "JOf15ijOtDbOJLLHPolcVaiO3IpIPVlW";
        ...
        .addEventListener("click", function(e) {
            ...
            var signature = ZoomMtg.generateSDKSignature({
                ...
                success: function(res) {
                    ...
                    var joinUrl = "http://127.0.0.1:5500/sample-app-web/CDN//meeting.html?" + testTool.serialize(meetingConfig);
                    console.log(joinUrl);
